...
<body>
    ...
    <div style="text-align:center;">
        ...
        <p> Enter the information of the new product</p>
        <form action="../php/addProduct.php" method="post">
            ...
            <input type="text" class="form-control" placeholder="Product name (required)" id="productName" name="productName"/>
            <input type="number" class="form-control" placeholder="Quantity" id="quantity" name="quantity"/>
            <input type="number" step="0.01" class="form-control" placeholder="Price" id="originalPrice" name="originalPrice"/>
            <input type="text" class="form-control" placeholder="Description" id="description" name="description"/>
            <!-- Button to add -->
            <button type="submit"  id="addButton" class="button4"> <i class="fas fa-plus"></i> Add Product </button>
        </form>
        <!-- Button to cancel -->
