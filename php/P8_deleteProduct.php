...
<body>
    ...
    <div style="text-align:center;">
        ...
        <p> Enter the ID of the product you wish to delete </p>
        <form action="../php/deleteProduct.php" method="post">
            <!-- Input field for ID of item to be deleted -->
            <input type="text" class="form-control" placeholder="Enter product ID" id="ID" name="ID"/>
            <!-- Button to delete -->
            <button type="submit" id="deleteButton" class="button button5"> <i class='far fa-trash-alt'></i> Delete product </button>
        </form>
        <!-- Button to cancel -->
